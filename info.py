...
BOT_TOKEN = environ.get('BOT_TOKEN', "6052078737:AAGig-BUQAOC2_hMihH7j4UmRR2SMZt5Jws")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001939186510').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5211097531').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5211097531').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1001939186510') #Channel / Group Id for force sub ( make sure bot is admin )
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001850979293')) #Log channel id ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001571367666'))
